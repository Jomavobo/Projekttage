...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const demoUsers = [
        { username: 'lehrer@schule.de', password: 'lehrer', name: 'Herr Müller', type: 'teacher' },
        { username: 'schueler@schule.de', password: 'schueler', name: 'Max Musterschüler', type: 'pupil' }
    ];
